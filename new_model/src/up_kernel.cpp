...
void lc_mgvf(INTERFACE_WIDTH *result, INTERFACE_WIDTH *imgvf, INTERFACE_WIDTH *I, unsigned int bonus)
{
...
#pragma HLS array_partition variable=dr complete dim=0
            ...
            int is_top = (i < GRID_COLS / WIDTH_FACTOR);
...
extern "C" {
__kernel void up_kernel(INTERFACE_WIDTH *result, INTERFACE_WIDTH *imgvf, INTERFACE_WIDTH *I, unsigned int bonus, unsigned iter)
{
