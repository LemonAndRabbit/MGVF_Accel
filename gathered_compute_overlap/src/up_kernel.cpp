...
void lc_mgvf(INTERFACE_WIDTH *result, INTERFACE_WIDTH *imgvf, INTERFACE_WIDTH *I)
{
    int cols = GRID_COLS;
    int rows = PART_ROWS;
...
extern "C" {
void up_kernel(INTERFACE_WIDTH *result, INTERFACE_WIDTH *imgvf, INTERFACE_WIDTH *I, unsigned iter)
{
    int i;
    for(i=0; i<iter/2; i++){
