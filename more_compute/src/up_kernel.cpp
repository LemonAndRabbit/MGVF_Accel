...
extern "C" {
__kernel void up_kernel(INTERFACE_WIDTH *result, INTERFACE_WIDTH *imgvf, INTERFACE_WIDTH *I)
{
    ...
    for(i=0; i<ITERATION/2; i++){
        lc_mgvf(result, imgvf - GRID_COLS/WIDTH_FACTOR, I, 2*i+1);
        lc_mgvf(imgvf, result - GRID_COLS/WIDTH_FACTOR, I, 2*i+2);
    }
