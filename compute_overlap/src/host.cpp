...
int main(int argc, char** argv) {
    ...
    OCL_CHECK(err, err = up_kernel.setArg(3, ITERATION-1));
    OCL_CHECK(err, err = up_kernel.setArg(4, ITERATION));
    ...
    OCL_CHECK(err, err = down_kernel.setArg(3, ITERATION));
    OCL_CHECK(err, err = down_kernel.setArg(4, ITERATION));
