...
int main(int argc, char** argv) {
    ...
    OCL_CHECK(err, err = up_kernel.setArg(3, shared_buffer1));
    OCL_CHECK(err, err = up_kernel.setArg(4, shared_buffer2));
    ...
    OCL_CHECK(err, err = down_kernel.setArg(3, shared_buffer2));
    OCL_CHECK(err, err = down_kernel.setArg(4, shared_buffer1));
